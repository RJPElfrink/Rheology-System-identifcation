...
u_transient_1, phase_u=rhs.multisine(N,f_s, f_0, [J1,J2],P=P,phase_response='Schroeder',time_domain=True)
...
u_transient_t, phase_u=rhs.multisine(N,f_s, f_0, [J1,J2],P=P,phase_response='Schroeder',time_domain=False)
